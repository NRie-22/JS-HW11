...
(0, _refs.refs).form.addEventListener("submit", (0, _handlers.onFormSubmit));
(0, _refs.refs).loadMoreBtn.addEventListener("click", (0, _handlers.onClickBtnLoadMore));

},{"./js/handlers":"jlk9X","./js/refs":"2WoF2"}],"jlk9X":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "onFormSubmit", ()=>onFormSubmit);
parcelHelpers.export(exports, "onClickBtnLoadMore", ()=>onClickBtnLoadMore);
...
const hideBtnLoadMore = ()=>(0, _refs.refs).loadMoreBtn.style.display = "none";
const showBtnLoadMore = ()=>(0, _refs.refs).loadMoreBtn.style.display = "block";
hideBtnLoadMore();
let page = 1;
let perPage = 40;
async function onFormSubmit(e) {
    e.preventDefault();
    let request = (0, _refs.refs).form.elements.searchQuery.value.trim();
    page = 1;
    cleanGallery();
    if (request === "") {
        hideBtnLoadMore();
        return (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
    }
    try {
        const galleryItems = await (0, _fetchimages.fetchImages)(request, page);
        ...
        if (galleryItems.data.hits.length === 0) {
            ...
            hideBtnLoadMore();
            (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${totalPages} image.`);
        } else if (totalPages > 40) {
            showBtnLoadMore();
            (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${totalPages} image.`);
        }
        (0, _createmarkup.renderGalleryMarkup)(galleryItems.data.hits);
        lightbox.refresh();
    } catch (error) {
        console.log(error);
        (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
...
function cleanGallery() {
    (0, _refs.refs).gallery.innerHTML = "";
    page = 1;
    hideBtnLoadMore();
}

},{"notiflix":"5z0Oc","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./refs":"2WoF2","./createmarkup":"fMiIy","./fetchimages":"9SDjO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"fMiIy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createGalleryMarkup", ()=>createGalleryMarkup);
parcelHelpers.export(exports, "renderGalleryMarkup", ()=>renderGalleryMarkup);
var _refs = require("./refs");
var _simpleLightboxMinCss = require("simplelightbox/dist/simple-lightbox.min.css");
function createGalleryMarkup(images) {
    return images.map(({ largeImageURL , webformatURL , tags , likes , views , comments , downloads ,  })=>`<div class="photo-card">
...
function renderGalleryMarkup(images) {
    (0, _refs.refs).gallery.insertAdjacentHTML("beforeend", createGalleryMarkup(images));
}

},{"./refs":"2WoF2","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kaxSc":[function() {},{}],"9SDjO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function fetchImages(value, page = 1, perPage = 40) {
    try {
        const response = await (0, _axiosDefault.default).get(`${BASE_URL}?key=${API_KEY}&q=${value}&image_type=photo&orientation=horizontal&safesearch=true&page=${page}&per_page=${perPage}`);
        return response;
    } catch (error) {
        console.log(error);
    }
